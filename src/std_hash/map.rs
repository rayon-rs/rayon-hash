          ...
          S: BuildHasher
{
    ...
    pub fn reserve(&mut self, additional: usize) {
        match self.private_try_reserve(additional) {
    ...
    pub fn try_reserve(&mut self, additional: usize) -> Result<(), CollectionAllocErr> {
        self.private_try_reserve(additional)
    }

    fn private_try_reserve(&mut self, additional: usize) -> Result<(), CollectionAllocErr> {
...
mod test_map {
    ...
    #[cfg(rayon_hash_unstable)] use alloc::CollectionAllocErr::*;
